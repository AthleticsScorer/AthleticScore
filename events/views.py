...
def bulk_create_results(request, f_id):
    ...
    event = get_object_or_404(Event, pk=f_
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/__init__.py", line 442, in execute_from_command_line
    utility.execute()
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/__init__.py", line 436, in execute
    self.fetch_command(subcommand).run_from_argv(self.argv)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/commands/test.py", line 24, in run_from_argv
    super().run_from_argv(argv)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/base.py", line 412, in run_from_argv
    self.execute(*args, **cmd_options)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/base.py", line 458, in execute
    output = self.handle(*args, **options)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/commands/test.py", line 68, in handle
    failures = test_runner.run_tests(test_labels)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/test/runner.py", line 1060, in run_tests
    self.run_checks(databases)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/test/runner.py", line 977, in run_checks
    call_command("check", verbosity=self.verbosity, databases=databases)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/__init__.py", line 194, in call_command
    return command.execute(*args, **defaults)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/base.py", line 458, in execute
    output = self.handle(*args, **options)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/commands/check.py", line 76, in handle
    self.check(
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/management/base.py", line 485, in check
    all_issues = checks.run_checks(
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/checks/registry.py", line 88, in run_checks
    new_errors = check(app_configs=app_configs, databases=databases)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/checks/urls.py", line 14, in check_url_config
    return check_resolver(resolver)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/core/checks/urls.py", line 24, in check_resolver
    return check_method()
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/urls/resolvers.py", line 494, in check
    for pattern in self.url_patterns:
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/utils/functional.py", line 57, in __get__
    res = instance.__dict__[self.name] = self.func(instance)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/urls/resolvers.py", line 715, in url_patterns
    patterns = getattr(self.urlconf_module, "urlpatterns", self.urlconf_module)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/utils/functional.py", line 57, in __get__
    res = instance.__dict__[self.name] = self.func(instance)
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/urls/resolvers.py", line 708, in urlconf_module
  ...
  File "/home/runner/work/AthleticScore/AthleticScore/AthleticsScore/urls.py", line 40, in <module>
    path('', include('events.urls')),
  File "/opt/hostedtoolcache/Python/3.8.18/x64/lib/python3.8/site-packages/django/urls/conf.py", line 38, in include
  ...
  File "<frozen importlib._bootstrap>", line 219, in _call_with_frames_removed
  File "/home/runner/work/AthleticScore/AthleticScore/events/urls.py", line 32
